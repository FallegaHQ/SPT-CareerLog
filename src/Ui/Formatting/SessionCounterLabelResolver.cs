...
internal static class SessionCounterLabelResolver{
    ...
    /// </summary>
    private static readonly Dictionary<string, string> GameKeyByField = new(System.StringComparer.Ordinal){
                                                                            // ----- Combat -----
                                                                            {
    ...
    public static string Resolve(string counterFieldName){
        ...
        return !string.Equals(fromModFile, modKey, System.StringComparison.Ordinal)
                   ? fromModFile
