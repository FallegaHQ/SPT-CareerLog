...
internal static class PaginationView{
    public static void Add(
        ...
        var barObject = new GameObject(
                                       UiHierarchy.RaidList.PaginationBar,
    ...
    private static void CreatePageLabel(
        ...
        var labelObject = new GameObject(
                                         UiHierarchy.RaidList.PageLabel,
                                         typeof(RectTransform),
        ...
        var tmp = labelObject.GetComponent<TextMeshProUGUI>();
        tmp.text               = LocaleLoader.Format(LocaleKeys.RaidsPageIndicator, pageIndex + 1, pageCount);
        tmp.fontSize           = Typography.Row;
